...
namespace DevCommom
{
    public class LevelUpManager
    {
        ...
        public void AddToMenu(ref Menu menu)
        {
            ...
            {
                Menu.AddSubMenu(new Menu("自動加點", "LevelUp"));
                Menu.SubMenu("LevelUp").AddItem(new MenuItem("LevelUp_" + ObjectManager.Player.ChampionName + "_啟用", "Enable").SetValue(true));
                Menu.SubMenu("LevelUp").AddItem(new MenuItem("LevelUp_" + ObjectManager.Player.ChampionName + "_選擇", "").SetValue(new StringList(SpellPriorityList.Keys.ToArray())));

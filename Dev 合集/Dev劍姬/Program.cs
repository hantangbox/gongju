    ...
    public class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>Dev鍔嶅К 鍔犺級鎴愬姛! v{0}QQ缇361630847</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        {
            Config = new Menu("Dev劍姬", "DevFiora", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRMinHit", "R 最少攻擊人數").SetValue(new Slider(2, 0, 5)));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRMinKill", "R 最少可擊殺人數").SetValue(new Slider(1, 0, 5)));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("ManaHarass", "騷擾最低藍量").SetValue(new Slider(30, 1, 100)));
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("UseWAgainstAA", "自動W抵擋").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("UseWAfterAttack", "在攻擊後 使用W").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("UseEAfterAttack", "在攻擊後 使用E").SetValue(true));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("ComboDamage", "顯示組合連招傷害").SetValue(true));

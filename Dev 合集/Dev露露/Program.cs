...
namespace DevLulu
{
    public class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Game.PrintChat(string.Format("<font color='#F7A100'>Dev闇查湶 鍔犺級鎴愬姛! v{0}姹夊寲by浜岀嫍!QQ缇361630847</font>", Assembly.GetExecutingAssembly().GetName().Version));
            ...
            Game.PrintChat(string.Format("<font color='#FF0000'>Dev闇查湶 鍔犺級鎴愬姛!: THIS ASSEMBLY IS NOT FINISHED YET!!!姹夊寲by浜岀嫍!QQ缇361630847</font>"));
        }

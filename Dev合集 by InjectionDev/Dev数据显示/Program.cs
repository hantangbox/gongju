...
namespace DevDebug
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("DevDebug Loaded 姹夊寲by浜岀嫍!QQ缇361630847");
        }
        ...
        {
            Config = new Menu("Dev鏁版嵁鏄剧ず", "DevDebug", true);

            Config.AddSubMenu(new Menu("鏄剧ず", "Draw"));
            Config.SubMenu("Draw").AddItem(new MenuItem("DrawBuffs", "鏄剧ず Buffs").SetValue(true));

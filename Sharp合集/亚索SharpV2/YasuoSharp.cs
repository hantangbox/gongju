        ...
        internal class YasuoSharp
        {
            ...
            private static void onLoad(EventArgs args)
            {
                ...
                try
                {
                    ...
                    Config = new Menu("浜氱储 Sharp V2", "Yasuo", true);
                    //Orbwalker
                    ...
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHit", "浣跨敤 R 浜烘暟")).SetValue(new Slider(3, 5, 1));
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHitTime", "浣跨敤 R 鍦ㄨ惤鍦板墠")).SetValue(true);
                    Config.SubMenu("combo").AddItem(new MenuItem("useEWall", "浣跨敤 E 淇濇姢鑷繁")).SetValue(true);
                    //Flee away
                    Config.SubMenu("combo").AddItem(new MenuItem("flee", "浣跨敤 E 閫冭窇")).SetValue(new KeyBind('Z', KeyBindType.Press, false));
                    Config.SubMenu("combo").AddItem(new MenuItem("fleeStack", "浣跨敤 Q2 鍑婚鑰岄€億")).SetValue(true);
                    ...
                    Config.SubMenu("lClear").AddItem(new MenuItem("useEmpQHit", "Q|鏈€灏戝嚮涓皬鍏垫暟閲弢")).SetValue(new Slider(3, 6, 1));
                    Config.SubMenu("lClear").AddItem(new MenuItem("useElc", "浣跨敤 E")).SetValue(true);
                    //Harass
                    Config.AddSubMenu(new Menu("楠氭壈 Sharp", "harass"));
                    Config.SubMenu("harass").AddItem(new MenuItem("harassTower", "绂佹濉斾笅楠氭壈")).SetValue(false);
                    Config.SubMenu("harass").AddItem(new MenuItem("harassOn", "鑷姩楠氭壈鏁屼汉")).SetValue(true);
                    Config.SubMenu("harass").AddItem(new MenuItem("harQ3Only", "鍙娇鐢≦楠氭壈")).SetValue(false);
                    //Drawings
                    Config.AddSubMenu(new Menu("鑼冨洿 Sharp", "drawing"));
                    Config.SubMenu("drawing").AddItem(new MenuItem("disDraw", "绂佺敤 鑼冨洿")).SetValue(false);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawQ", "鏄剧ず Q 鑼冨洿")).SetValue(true);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawE", "鏄剧ず E 鑼冨洿")).SetValue(true);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawR", "鏄剧ず R 鑼冨洿")).SetValue(true);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawWJ", "鏄剧ず 璺冲 浣嶇疆")).SetValue(true);

                    //Extra
                    Config.AddSubMenu(new Menu("棰濆 Sharp", "extra"));
                    Config.SubMenu("extra").AddItem(new MenuItem("djTur", "绂佹E鍏ュ涓媩")).SetValue(true);
                    ...
                    //LastHit
                    Config.AddSubMenu(new Menu("娉曟湳 鎶垫尅", "aShots"));
                    //SmartW
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartW", "鏅鸿兘 W")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartEDogue", "浣跨敤E韬查伩鍗遍櫓鎶€鑳絴")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDanger", "浣跨敤W鎶垫尅鍗遍櫓鎶€鑳絴")).SetValue(false);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDmg", "浣跨敤W|琛€閲忎綆浜巪")).SetValue(new Slider(0, 100, 1));
                    skillShotMenu = getSkilshotMenu();
                    Config.SubMenu("aShots").AddSubMenu(skillShotMenu);
                    //Debug
                    Config.AddSubMenu(new Menu("璋冭瘯", "debug"));
                    Config.SubMenu("debug").AddItem(new MenuItem("WWLast", "鏈€鍚庝娇鐢╓鐩栧附")).SetValue(new KeyBind('T', KeyBindType.Press, false));
                    Config.SubMenu("debug").AddItem(new MenuItem("saveDash", "淇濈暀 浣嶇Щ")).SetValue(new KeyBind('O', KeyBindType.Press, false));
                    Config.SubMenu("debug").AddItem(new MenuItem("exportDash", "浣跨敤 浣嶇Щ")).SetValue(new KeyBind('P', KeyBindType.Press, false));
                    Config.SubMenu("debug").AddItem(new MenuItem("deleteDash", "绂佺敤 浣嶇Щ")).SetValue(new KeyBind('I', KeyBindType.Press, false));

...
namespace YasuoSharpV2
{
        internal class YasuoSharp
        {
            ...
            private static void onLoad(EventArgs args)
            {
                ...
                Game.PrintChat("浜氱储SharpV2 by DeTuKs 鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍锛丵Q缇361630847");
                ...
                try
                {
                    ...
                    Config = new Menu("亚索 Sharp V2", "Yasuo", true);
                    //Orbwalker
                    ...
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHit", "使用 R 人数")).SetValue(new Slider(3, 5, 1));
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHitTime", "使用 R 在落地前")).SetValue(true);
                    Config.SubMenu("combo").AddItem(new MenuItem("useEWall", "使用 E 保护自己")).SetValue(true);
                    //Flee away
                    Config.SubMenu("combo").AddItem(new MenuItem("flee", "使用 E 逃跑")).SetValue(new KeyBind('Z', KeyBindType.Press, false));
                    Config.SubMenu("combo").AddItem(new MenuItem("fleeStack", "使用 Q2 击飞而逃")).SetValue(true);
                    ...
                    Config.SubMenu("lClear").AddItem(new MenuItem("useEmpQHit", "Q|最少击中小兵数量")).SetValue(new Slider(3, 6, 1));
                    Config.SubMenu("lClear").AddItem(new MenuItem("useElc", "使用 E")).SetValue(true);
                    //Harass
                    Config.AddSubMenu(new Menu("骚扰 Sharp", "harass"));
                    Config.SubMenu("harass").AddItem(new MenuItem("harassTower", "禁止塔下骚扰")).SetValue(false);
                    Config.SubMenu("harass").AddItem(new MenuItem("harassOn", "自动骚扰敌人")).SetValue(true);
                    Config.SubMenu("harass").AddItem(new MenuItem("harQ3Only", "只使用Q骚扰")).SetValue(false);
                    //Drawings
                    Config.AddSubMenu(new Menu("范围 Sharp", "drawing"));
                    Config.SubMenu("drawing").AddItem(new MenuItem("disDraw", "禁用 范围")).SetValue(false);
                    ...
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawWJ", "显示 跳墙 位置")).SetValue(true);

                    //Extra
                    Config.AddSubMenu(new Menu("额外 Sharp", "extra"));
                    Config.SubMenu("extra").AddItem(new MenuItem("djTur", "禁止E入塔下")).SetValue(true);
                    ...
                    //LastHit
                    Config.AddSubMenu(new Menu("法术 抵挡", "aShots"));
                    //SmartW
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartW", "智能 W")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartEDogue", "使用E躲避危险技能")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDanger", "使用W抵挡危险技能")).SetValue(false);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDmg", "使用W|血量低于")).SetValue(new Slider(0, 100, 1));
                    skillShotMenu = getSkilshotMenu();
                    Config.SubMenu("aShots").AddSubMenu(skillShotMenu);
                    //Debug
                    Config.AddSubMenu(new Menu("调试", "debug"));
                    Config.SubMenu("debug").AddItem(new MenuItem("WWLast", "团战使用W盖帽")).SetValue(new KeyBind('T', KeyBindType.Press, false));

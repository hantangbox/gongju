...
namespace KarthusRForRAWR
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Keys")
               .AddItem(
                   new MenuItem("wTar", "手动对目标W").SetValue(new KeyBind("W".ToCharArray()[0],
                       KeyBindType.Press)));
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("lastHitQ", "补刀 Q").SetValue(new KeyBind("A".ToCharArray()[0],
                        KeyBindType.Press)));
            menu.SubMenu("Keys")
                .AddItem(
            ...
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qAA", "自动对目标Q").SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qImmo", "自动 Q 不动的").SetValue(true));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qDash", "自动 Q 移动的").SetValue(true));
            //W
            ...
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("wIfMana", "足够的蓝量用连招才使用W").SetValue(true));
            //E
            menu.SubMenu("Spell").AddSubMenu(new Menu("E 法术", "ESpell"));
            menu.SubMenu("Spell").SubMenu("ESpell").AddItem(new MenuItem("eManaCombo", "连招E|最低蓝量").SetValue(new Slider(10, 0, 100)));
            menu.SubMenu("Spell").SubMenu("ESpell").AddItem(new MenuItem("eManaHarass", "骚扰E|最低蓝量").SetValue(new Slider(70, 0, 100)));
            //R
            menu.SubMenu("Spell").AddSubMenu(new Menu("R 法术", "RSpell"));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("rPing", "全图可击杀自动R").SetValue(true));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("qHit", "Q 命中率").SetValue(new Slider(3, 1, 4)));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("qHit2", "Q 命中率").SetValue(new Slider(3, 1, 4)));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("minMana", "骚扰最低蓝量").SetValue(new Slider(60, 0, 100)));

            //Farming menu:
            menu.AddSubMenu(new Menu("杂项", "Farm"));
            ...
            menu.SubMenu("Drawings").AddItem(new MenuItem("drawUlt", "R 击杀提示").SetValue(true));
            menu.SubMenu("Drawings")
            ...
            Game.PrintChat("|姝讳骸姝岄鑰厊-鍗″皵钀ㄦ柉--- by xSalice 鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍锛丵Q缇361630847!");
        }

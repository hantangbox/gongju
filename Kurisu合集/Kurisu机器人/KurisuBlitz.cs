...
namespace KurisuBlitz
{
    ...
    internal class KurisuBlitz
    {
        ...
        {
            _menu = new Menu("Kurisu|鏈哄櫒浜簗", "blitz", true);
            ...
            menuG.AddItem(new MenuItem("dneeded2", "鏈€杩滆窛绂籕")).SetValue(new Slider((int)Q.Range, 0, (int)Q.Range));
            ...
            menuG.AddItem(new MenuItem("hneeded", "涓峇|鐢熷懡鍊间綆浜巪%")).SetValue(new Slider(0));
            ...
            _menu.AddItem(new MenuItem("useE", "Q涓嚜鍔‥")).SetValue(true);

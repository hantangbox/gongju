...
namespace KurisuRiven
{
    internal class KurisuRiven
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            // Target Selector
            Menu menuTS = new Menu("瑞文:目标选择", "tselect");
            SimpleTs.AddToMenu(menuTS);
            config.AddSubMenu(menuTS);

            // Orbwalker
            Menu menuOrb = new Menu("瑞文:走砍", "orbwalker");
            orbwalker = new Orbwalking.Orbwalker(menuOrb);
            config.AddSubMenu(menuOrb);

            Menu menuK = new Menu("瑞文:键位设置", "demkeys");
            ...
            // Draw settings
            Menu menuD = new Menu("瑞文:范围设置", "dsettings");
            ...
            // Combo Settings
            Menu menuC = new Menu("瑞文:瑞文设置", "csettings");
            ...
            menuC.AddItem(new MenuItem("asep2", "==== 多重-连招设置"));
            menuC.AddItem(new MenuItem("ssWQ", "尝试 W->Q")).SetValue(true);
            menuC.AddItem(new MenuItem("ssEQ", "尝试 E->Q")).SetValue(true);
            menuC.AddItem(new MenuItem("ssEWS", "尝试 E->风速斩")).SetValue(true);
            menuC.AddItem(new MenuItem("ssWSQ", "尝试 风速斩->Q")).SetValue(true);

            config.AddSubMenu(menuC);

            // Extra Settings
            Menu menuO = new Menu("瑞文:额外设置", "osettings");
            menuO.AddItem(new MenuItem("osep2", "==== 额外设置"));
            menuO.AddItem(new MenuItem("useignote", "使用 点燃")).SetValue(true);
            menuO.AddItem(new MenuItem("enableAntiG", "使用 防止突进")).SetValue(true);
            ...
            menuO.AddItem(new MenuItem("wslash", "风速斩:"))
                .SetValue(new StringList(new[] { "可以击杀", "最大伤害" }, 1));
            ...
            // Farm/Clear Settings
            Menu menuJ = new Menu("瑞文:清线|清野", "jsettings");
            ...
            Menu rivenD = new Menu("瑞文:调试设置", "therivend");
            ...
            Game.PrintChat("<font color='" + hex + "'>Kurisu鐟炴枃 r.0998</font> - 璇诲彇鎴愬姛锛侊紒锛亅 鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847");
            Game.PrintChat("<font color='" + hex + "'>Kurisu鐟炴枃</font> has been used in <font color='" + hex + "'>" + intamount + "</font> games."); // Post Counter Data

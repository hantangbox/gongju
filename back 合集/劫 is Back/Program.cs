...
namespace Zed
{
    internal class program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("|劫|", "Ze-D Is Back", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseWC", "使用W|敌人突进")).SetValue(true);
    ...
    .AddItem(new MenuItem("TheLine", "连招（先R)").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            ...
            _config.SubMenu("Farm")
                ...
                .SetValue(true);
            _config.SubMenu("Farm").SubMenu("LaneFarm").AddItem(new MenuItem("UseQL", "使用 Q 清线")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("LaneFarm").AddItem(new MenuItem("UseEL", "使用 E 清线")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("LaneFarm")
            ...
            _config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseQLH", "使用 Q 补刀")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseELH", "使用 E 补刀")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("LastHit")
            ...
            _config.SubMenu("Farm")
                ...
                .SetValue(true);
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("UseQJ", "使用 Q 清野")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("UseWJ", "使用 W 清野")).SetValue(true);
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("UseEJ", "使用 E 清野")).SetValue(true);
            _config.SubMenu("Farm")
                .SubMenu("Jungle")
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("rdodge", "自动R躲避技能")).SetValue(true);

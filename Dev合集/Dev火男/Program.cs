    ...
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>DevBrand Loaded v{0}姹夊寲by浜岀嫍!QQ缇361630847</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        {
            Config = new Menu("Dev鐏敺", "DevBrand", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRMinEnemies", "浣跨敤R鏁屾柟浜烘暟").SetValue(new Slider(2, 1, 5)));
            Config.SubMenu("Combo").AddItem(new MenuItem("PriorizeStunCombo", "鑷姩Q鐪╂檿").SetValue(true));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("PriorizeStunHarass", "鑷姩Q鐪╂檿").SetValue(true));

            Config.AddSubMenu(new Menu("娓呴噹", "LaneClear"));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "娓呯嚎鏈€浣庤摑閲弢").SetValue(new Slider(30, 1, 100)));

    ...
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>DevAnnie Loaded v{0}姹夊寲by浜岀嫍!QQ缇361630847</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config.AddSubMenu(new Menu("鏉傞」", "Mode"));
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRMinEnemies", "浣跨敤R浜烘暟").SetValue(new Slider(2, 1, 5)));
            ...
            Config.SubMenu("FlashCombo").AddItem(new MenuItem("FlashComboMinEnemies", "浣跨敤闂幇杩炴嫑鏈€灏戜汉鏁皘").SetValue(new Slider(2, 1, 5)));
            Config.SubMenu("FlashCombo").AddItem(new MenuItem("FlashAntiSuicide", "浣跨敤闂幇闃插嚮鏉€").SetValue(true));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("UseQHarassLastHit", "浣跨敤 Q 琛ュ垁").SetValue(true));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "浣跨敤W娓呯嚎鏈€浣庤摑閲弢").SetValue(new Slider(30, 1, 100)));
            ...
            Config.SubMenu("Extra").AddItem(new MenuItem("PacketCast", "浣跨敤 灏佸寘").SetValue(true));
            Config.SubMenu("Extra").AddItem(new MenuItem("UseEAgainstAA", "E鐨勯棿闅欎娇鐢ㄨ蛋A").SetValue(true));
            Config.SubMenu("Extra").AddItem(new MenuItem("UseRInterrupt", "浣跨敤R涓柇娉曟湳").SetValue(true));

            Config.AddSubMenu(new Menu("绐佽繘缁堢粨鑰厊", "GapCloser"));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("UseEGapCloser", "瀵圭獊杩涜€呬娇鐢‥").SetValue(true));

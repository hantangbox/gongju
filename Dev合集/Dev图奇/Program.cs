    ...
    class Program
    {
        ...
        private static void onGameLoad(EventArgs args)
        {
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>DevTwitch Loaded v{0}姹夊寲by浜岀嫍!QQ缇361630847</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config = new Menu("Dev鍥惧", "DevTwitch", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("MinPassiveStackUseECombo", "浣跨敤E鏈€澶у眰鏁皘").SetValue(new Slider(3, 1, 6)));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("MinPassiveStackUseEHarass", "浣跨敤E鏈€澶у眰鏁皘").SetValue(new Slider(2, 1, 6)));
            Config.SubMenu("Harass").AddItem(new MenuItem("ManaHarass", "楠氭壈鏈€浣庤摑閲弢").SetValue(new Slider(50, 1, 100)));
            ...
            Config.SubMenu("KillSteal").AddItem(new MenuItem("EKillSteal", "E 鎶汉澶磡").SetValue(true));
            Config.SubMenu("KillSteal").AddItem(new MenuItem("RKillSteal", "R 鎶汉澶磡").SetValue(true));
            ...
            //Config.SubMenu("GapCloser").AddItem(new MenuItem("QGapCloser", "鏁屼汉绐佽繘浣跨敤Q").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("BarrierGapCloser", "闃绘柇绐佽繘鑰厊").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("BarrierGapCloserMinHealth", "闃绘柇绐佽繘鑰厊鏈€浣庤閲弢").SetValue(new Slider(40, 0, 100)));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("RDamage", "鏄剧ずR浼ゅ").SetValue(true));

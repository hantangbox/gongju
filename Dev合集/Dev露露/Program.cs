...
namespace DevLulu
{
    public class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat(string.Format("<font color='#FF0000'>DevLulu: THIS ASSEMBLY IS NOT FINISHED YET!!!姹夊寲by浜岀嫍!QQ缇361630847</font>"));
        }
        ...
        {
            Config = new Menu("Dev闇查湶", "DevLulu", true);
            ...
            Config.SubMenu("Mode").AddItem(new MenuItem("ModeType", "妯″紡绫诲瀷").SetValue(new StringList(new[] { "涓崟", "杈呭姪" })));
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEQCombo", "瀵硅繙澶勬晫浜轰娇鐢‥Q").SetValue(true));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("UseEQHarass", "瀵硅繙澶勬晫浜轰娇鐢‥Q").SetValue(true));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "娓呯嚎鏈€浣庤摑閲弢").SetValue(new Slider(25, 1, 100)));

            Config.AddSubMenu(new Menu("鎺х嚎", "Freeze"));
            Config.SubMenu("Freeze").AddItem(new MenuItem("UseQFreeze", "浣跨敤 Q 琛ュ垁").SetValue(true));
            Config.SubMenu("Freeze").AddItem(new MenuItem("ManaFreeze", "娣峰悎鏈€浣庤摑閲弢").SetValue(new Slider(25, 1, 100)));

            Config.AddSubMenu(new Menu("R璁剧疆", "Ultimate"));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("UseRAlly", "瀵归槦鍙嬩娇鐢≧").SetValue(true));
            Config.SubMenu("Ultimate").AddItem(new MenuItem("UseRAllyMinHealth", "浣跨敤R|闃熷弸琛€閲弢").SetValue(new Slider(30, 1, 100)));

            Config.AddSubMenu(new Menu("鏀彺闃熷弸", "HelpAlly"));
            Config.SubMenu("HelpAlly").AddItem(new MenuItem("UseWHelpAlly", "浣跨敤 W").SetValue(true));
            Config.SubMenu("HelpAlly").AddItem(new MenuItem("UseEHelpAlly", "浣跨敤 E").SetValue(true));
            Config.SubMenu("HelpAlly").AddItem(new MenuItem("AllyMinHealth", "鏀彺闃熷弸鏈€浣庤閲弢").SetValue(new Slider(50, 1, 100)));

            Config.AddSubMenu(new Menu("鏉傞」", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "浣跨敤 灏佸寘").SetValue(true));
            ...
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WGapCloser", "浣跨敤W闃叉绐佽繘").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WInterruptSpell", "浣跨敤W涓柇娉曟湳").SetValue(true));

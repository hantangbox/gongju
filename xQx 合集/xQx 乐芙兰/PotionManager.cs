...
namespace Leblanc
{
    internal class PotionManager
    {
        ...
        private void Load()
        {
            ...
            Program.MenuExtras.AddSubMenu(new Menu("药水 大师", "PotionManager"));

            Program.MenuExtras.SubMenu("PotionManager").AddSubMenu(new Menu("红药", "Health"));
            Program.MenuExtras.SubMenu("PotionManager").SubMenu("Health").AddItem(new MenuItem("HealthPotion", "使用 红药").SetValue(true));
            Program.MenuExtras.SubMenu("PotionManager").SubMenu("Health").AddItem(new MenuItem("HealthPercent", "使用红药最低血量").SetValue(new Slider(30)));

            Program.MenuExtras.SubMenu("PotionManager").AddSubMenu(new Menu("蓝药", "Mana"));
            Program.MenuExtras.SubMenu("PotionManager").SubMenu("Mana").AddItem(new MenuItem("ManaPotion", "使用 蓝药").SetValue(true));
            Program.MenuExtras.SubMenu("PotionManager").SubMenu("Mana").AddItem(new MenuItem("ManaPercent", "使用蓝药最低蓝量").SetValue(new Slider(30)));

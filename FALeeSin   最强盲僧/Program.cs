...
namespace FuckingAwesomeLeeSin
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu.SubMenu("Combo").AddItem(new MenuItem("useW", "杩炴嫑浣跨敤鐬溂").SetValue(true));
            Menu.SubMenu("Combo").AddItem(new MenuItem("dsjk", "浣跨敤鐬溂 濡傛灉: "));
            Menu.SubMenu("Combo").AddItem(new MenuItem("wMode", "鏁屼汉绂诲紑璧癆鍜孮鑼冨洿").SetValue(true));
            ...
            harassMenu.AddItem(new MenuItem("wH", "鐬溂/鏁屼汉闂幇(绂佺敤)").SetValue(false));
            ...
            insecMenu.AddItem(new MenuItem("waitForQBuff", "绛夊緟Q CD").SetValue(false));
            ...
            //Wardjump menu
            var wardjumpMenu = new Menu("鐬溂璁剧疆", "Wardjump");
            wardjumpMenu.AddItem(
                new MenuItem("wjump", "鐬溂閿綅").SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Press)));
            wardjumpMenu.AddItem(new MenuItem("maxRange", "鎬绘槸鐬溂鏈€澶ц寖鍥磡").SetValue(false));
            ...
            drawMenu.AddItem(new MenuItem("WJDraw", "鐬溂鑼冨洿").SetValue(true));

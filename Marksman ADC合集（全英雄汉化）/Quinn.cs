...
namespace Marksman
{
    internal class Quinn : Champion
    {
        ...
        public Quinn()
        {
            Utils.PrintMessage("Quinn loaded 姹夊寲by浜岀嫍!QQ缇361630847.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETC" + Id, "鐐涓嬬鐢‥").SetValue(true));
            config.AddItem(new MenuItem("UseETK" + Id, "鐐涓嬩娇鐢‥(鍙嚮鏉€锛墊")
                .SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseETH" + Id, "鐐涓嬬鐢‥").SetValue(true));
            config.AddItem(
                new MenuItem("UseQTH" + Id, "浣跨敤 Q (鎸佺画)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));             
            return true;
        }

...
namespace Marksman
{
    internal class Teemo : Champion
    {
        ...
        public Teemo()
        {
            Utils.PrintMessage("Teemo loaded 姹夊寲by浜岀嫍!QQ缇361630847.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseRC" + Id, "浣跨敤 R").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseQM" + Id, "浣跨敤Q鎶汉澶磡").SetValue(true));
            return true;
        }

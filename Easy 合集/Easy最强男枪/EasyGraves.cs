...
namespace EasyJinx
{
    class EasyGraves : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_q", "浣跨敤 Q").SetValue(false));
            ...
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_wgap", "鍦ㄦ洿闈犺繎宸窛涓妡 浣跨敤 W ").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_wgapmana", "鍙湁褰撴硶鍔泑 > 杩炴嫑娉曞姏鎵嶄娇鐢▅").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_r", "鍑绘潃鑳藉姏涓妡 浣跨敤 R ").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_rrange", "鍙湁瓒呭嚭R鑼冨洿 ").SetValue(true));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_r", "R 鑼冨洿").SetValue(new Circle(true, System.Drawing.Color.FromArgb(100, 0, 255, 0))));

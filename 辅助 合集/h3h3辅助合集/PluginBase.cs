...
namespace Support
{
    ...
    public abstract class PluginBase
    {
        ...
        private void InitConfig()
        {
            ...
            ManaConfig = Config.AddSubMenu(new Menu("娉曞姏闄愬埗鍣▅", "Mana Limiter"));
            MiscConfig = Config.AddSubMenu(new Menu("棰濆鍔熻兘", "Misc"));
            ...
            // mana
            ManaConfig.AddSlider("HarassMana", "楠氭壈娉曞姏鍊肩櫨鍒嗘瘮|", 1, 1, 100);

            // misc
            MiscConfig.AddBool("UsePackets", "浣跨敤灏佸寘", true);
            MiscConfig.AddList("AttackMinions", "鏀诲嚮灏忓叺", new[] { "鏅鸿兘", "鍐充笉", "鎬绘槸" });
            MiscConfig.AddBool("AttackChampions", "鏀诲嚮鍐犲啗", true);

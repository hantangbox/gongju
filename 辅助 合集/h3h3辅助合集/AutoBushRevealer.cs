...
namespace Support
{
    public class AutoBushRevealer
    {
        ...
        public AutoBushRevealer(Menu menu)
        {
            ...
            _menu = menu.AddSubMenu(new Menu("鑷姩鑽変笡渚︽祴", "AutoBushRevealerMenu"));
            _menu.AddItem(new MenuItem("Auto Bush Revealer", "鑷姩鑽変笡渚︽祴").SetValue(true));
            _menu.AddItem(new MenuItem("AutoBushEnabled", "鍚敤").SetValue(true));

            var useWardsMenu = _menu.AddSubMenu(new Menu("浣跨敤 瀹堝崼: ", "AutoBushUseWards"));

...
namespace Marksman
{
    internal class Kogmaw : Champion
    {
        ...
        public Kogmaw()
        {
            Utils.PrintMessage("KogMaw loaded 姹夊寲by浜岀嫍!QQ缇361630847.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "浣跨敤R闄愬埗浜烘暟").SetValue(new Slider(3, 5, 1)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "浣跨敤 E").SetValue(false));
            config.AddItem(new MenuItem("UseRH" + Id, "浣跨敤 R").SetValue(true));
            config.AddItem(new MenuItem("RlimH" + Id, "浣跨敤R闄愬埗浜烘暟").SetValue(new Slider(1, 5, 1)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q 鑼冨洿").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawW" + Id, "W 鑼冨洿").SetValue(new Circle(true,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawE" + Id, "E 鑼冨洿").SetValue(new Circle(false,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawR" + Id, "R 鑼冨洿").SetValue(new Circle(false,
                    System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            return true;
        }

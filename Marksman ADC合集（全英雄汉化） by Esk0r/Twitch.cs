...
namespace Marksman
{
    internal class Twitch : Champion
    {
        ...
        public Twitch()
        {
            Utils.PrintMessage("Twitch loaded 姹夊寲by浜岀嫍!QQ缇361630847.");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "鑷姩E(鏈€澶у眰鏁?").SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "鑷姩E(鏈€澶у眰鏁?").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(new MenuItem("UseEM" + Id, "浣跨敤E鎶汉澶磡").SetValue(true));
            return true;
        }

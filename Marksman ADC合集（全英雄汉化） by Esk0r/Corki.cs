...
namespace Marksman
{
    internal class Corki : Champion
    {
        ...
        public Corki()
        {
            Utils.PrintMessage("Corki loaded 姹夊寲by浜岀嫍!QQ缇361630847");
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimC" + Id, "淇濇寔R鍫嗗彔").SetValue(new Slider(0, 0, 7)));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("RlimH" + Id, "淇濇寔R鍫嗗彔").SetValue(new Slider(3, 0, 7)));
            return true;
        }

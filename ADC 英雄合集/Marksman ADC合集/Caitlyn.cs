...
namespace Marksman
{
    internal class Caitlyn : Champion // Base done by xQx, Drawings and improvements added by Dibes.
    {
        ...
        public override bool DrawingMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("DrawUlt" + Id, "大招伤害（文本）").SetValue(new Circle(true, Color.FromArgb(255, 255, 255, 255))));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("UltHelp" + Id, "对攻击目标使用R").SetValue(new KeyBind("R".ToCharArray()[0],
                    KeyBindType.Press)));
            config.AddItem(

...
namespace Marksman
{
    internal class Tristana : Champion
    {
        ...
        {
            config.AddItem(
                new MenuItem("DrawE" + Id, "E r范围").SetValue(new Circle(true, Color.CornflowerBlue)));
            return true;
        }
        ...
        public override bool MiscMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseRMG" + Id, "使用 R 防止突进").SetValue(true));
            config.AddItem(new MenuItem("UseRMI" + Id, "使用 R 中断法术").SetValue(true));
            return true;
        }
